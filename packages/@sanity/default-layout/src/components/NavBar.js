...
import SearchController from './SearchController2'
...
function NavBar(props) {
  ...
  return (
    <div className={styles.root} data-search-open={searchIsOpen}>
      ...
      <div className={styles.search} data-is-open={searchIsOpen}>
        <div>
          <SearchController isOpen={searchIsOpen} onOpen={onSearchOpen} onClose={onSearchClose} />
        </div>
      </div>
